...
**Awesome Books** In this project, we will built a basic website that allows users to add/remove books from a list. I achieved that by using ES6 modules and arrow function. I also dynamically modified the DOM and added basic events
...
- [Live Demo]( https://tsheporamantso.github.io/Awesome-books-ES6/)
...
```sh
  cd my-folder
  git clone git@github.com:tsheporamantso/Awesome-books-ES6.git
```
...
Feel free to check the [issues page](https://github.com/tsheporamantso/Awesome-books-ES6/issues).
